...
<main class="col-lg-8 col-12">
    ...
    <p class="texto-noticia">Não quero dizer que estes produtos deveriam ser abolidos e extintos, mas que os recursos que oferecem fossem mais úteis para o cidadão comum. Pense bem, em que momento na sua vida você cogitou usar um porta ovo conectado à sua internet? Ou então um dispenser de fio dental automático? São coisas tão fúteis, mas que mesmo assim possuem palco e compradores. O fato mais interessante de tudo isso é que além de pagar caro por versões “aprimoradas” de algo que já existia em sua casa, você ainda é refém da empresa que construiu e vendeu o dispositivo, afinal todos eles precisam de programas específicos para funcionarem, ou então até refills que só a empresa fornece (lixeiras ou dispensers).</p>
