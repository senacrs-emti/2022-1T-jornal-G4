...
<main class="col-lg-8 col-12">
    ...
    <p class="texto-noticia">Este artigo de opinião visa conscientizar a todos sobre a erotização precoce e seus males, deixando claro que existem exceções e contextos diferentes tornando cada caso único. </p>
    <h4 class="texto-noticia">REFERÊNCIAS</h4>
    <p class="texto-noticia">https://pt.wikipedia.org/wiki/Xou_da_Xuxa </p>
    <p class="texto-noticia">https://www.semprefamilia.com.br/educacao-dos-filhos/riscos-erotizacao-precoce-infancia-como-pais-podem-evitar/ </p>
